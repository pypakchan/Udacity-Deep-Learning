...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print('self.weights_hidden_to_output.T: {}'.format(self.weights_hidden_to_output.T.shape))
        #print('hidden_error: {}'.format(hidden_error.shape))
        #print('hidden_error_term: {}'.format(hidden_error_term.shape))
